  ...
  return (
    <Layout>
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6 py-10 border-t border-neutral-100">
        ...
        <p className="mt-3 text-neutral-700 max-w-prose">Find my papers and their podcasts here.</p>
        <div className="mt-4">
      ...
      {/* Media — sequential section (remove if you want it hidden) */}
      <section className="mx-auto max-w-5xl px-4 sm:px-6 py-10 border-t border-neutral-100">
        <h2 className="text-2xl font-semibold">Success Stories / Media</h2>
        <p className="mt-3 text-neutral-700 max-w-prose">
          See how entrepreneurs and entrepreneurship students use the Navigator; plus selected talks &amp; features.
        </p>
        <div className="mt-4">
          <a href="/media" className="inline-flex items-center px-4 py-2 rounded-xl border border-neutral-200">
            Explore
          </a>
        </div>
      </section>
