        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 items-start">
          <div className="md:col-span-3">
            ...
            <p className="mt-4 text-neutral-700 max-w-prose">
              ...
              to AI effectively for entrepreneurship, from ideation to validation, prototyping and marketing.
            </p>
          ...
          <div className="md:col-span-2">
            <div className="aspect-[4/5] w-full rounded-2xl bg-neutral-100 overflow-hidden shadow-sm">
              <img src="/headshot.jpeg" alt="Stephen X. Zhang headshot" className="h-full w-full object-cover" />
            </div>
          </div>
        </div>
      </section>
